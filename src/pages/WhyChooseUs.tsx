...
const WhyChooseUs = () => {
  const reasons = [
    ...
    },
    {
      ...
      description:
        "Reliable and punctual delivery service to meet your business needs.",
    },
    {
      icon: Award,
      title: "Premium Selection",
      description:
        "Carefully selected premium products from trusted sources.",
    },
    {
      icon: Clock,
      title: "Fresh Supply",
      description:
        "Regular fresh supply to ensure the best quality for your customers.",
    },
    {
      icon: Users,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            At RKreate, we pride ourselves on delivering excellence in every aspect
            of our service. Discover why businesses trust us as their seafood
            supplier.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="mt-20 bg-white rounded-xl shadow-lg p-8 text-center"
        >
